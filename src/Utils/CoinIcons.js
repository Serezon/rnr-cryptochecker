...
export const images = {
  ...
  BSV: 'https://res.cloudinary.com/diqyizgaz/image/upload/v1543262963/crypto-icons/bitcoinsv.png',
  USDT: 'https://res.cloudinary.com/diqyizgaz/image/upload/v1543262962/crypto-icons/tether.png',
